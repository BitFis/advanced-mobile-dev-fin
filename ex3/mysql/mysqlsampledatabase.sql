...
--
-- Host: db
-- Generation Time: Dec 05, 2019 at 10:47 AM
...
INSERT INTO `feedback` (`id`, `name`, `value`, `location`) VALUES
(1, 'Hans Example', 'This is a test feedback for later', 'rovaniemi, fi');
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`id`,`checkNumber`);
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`id`) REFERENCES `customers` (`id`);
